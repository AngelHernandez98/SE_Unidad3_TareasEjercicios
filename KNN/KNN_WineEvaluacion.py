...
archivo = open("wine_training90.0.csv", "r") #Colocar la instancia de entrenamiento proporcionada por el Dr.
...
###########################################################################
archivo = open("wine_test90.0.csv","r") #Colocar la instancia de prueba proporcionada por el Dr.
contenido = archivo.readlines()
